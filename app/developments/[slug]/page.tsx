...
// One small icon per document type — keeps the card grid scannable
// without relying on an icon library.
...
export default async function DevelopmentPage({
  ...
  return (
    <main className={`min-h-screen bg-white text-black ${montserrat.className}`}>
      {/* Header — logo is now clickable too, not just the text link */}
      ...
      {/* Hero — gradient overlay instead of a flat tint, price + builder badge */}
            ...
            <div className="flex items-center gap-3 mt-4">
              {development.builder && (
                <div className="flex items-center gap-2 bg-white/95 rounded-md pl-3 pr-3 py-1.5">
                  ...
                  {/* Lindvest wordmark — kept small and secondary to the Fallico
                      brand, which stays the dominant identity throughout. */}
                  <img
      ...
      {/* Blurb — red accent bar echoes the logo's own mark */}
